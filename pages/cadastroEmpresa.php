                ...
                <form action="cadastroEmpresa.php" method="POST" enctype="multipart/form-data" novalidate>
                    <div class="grade">
                        <div class="campo">
                            ...
                            <input type="text" name="nome_empresa" value="<?= old($antigos, 'nome_empresa') ?>"
                                required>
                            <?= erro($erros, 'nome_empresa') ?>
                        </div>
                        <div class="campo">
                            <label>Telefone *</label>
                            <input type="tel" name="telefone" id="telefone" placeholder="(51) 99999-9999"
                                value="<?= old($antigos, 'telefone') ?>" required>
                            <?= erro($erros, 'telefone') ?>
                        </div>
                        <div class="campo">
                            <label>Email *</label>
                            <input type="email" name="email" value="<?= old($antigos, 'email') ?>" required>
                            <?= erro($erros, 'email') ?>
                        </div>
                        <div class="campo">
                            <label>Senha *</label>
                        ...
                        <div class="campo campo-largo">
                            ...
                            <input type="text" name="endereco" value="<?= old($antigos, 'endereco') ?>">
                        </div>
                    ...
                    <a href="login.php" class="toggle-link">
                        Já tenho uma conta
                    </a>
                </form>
            </div>
