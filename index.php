...
// -----------------------------------------------------
// 1. Descobre qual aba está aberta (vagas, usuarios ou empresas)
// -----------------------------------------------------
...
// -----------------------------------------------------
// 2. Trata a exclusão (quando o admin clica em "Excluir")
// -----------------------------------------------------
if (isset($_GET["excluir"]) && isset($_GET["id"])) {
    ...
    // Depois de excluir, volta para a mesma aba (sem os parâmetros de exclusão na URL)
    header("Location: index.php?aba=" . $aba);
    exit;
}

// -----------------------------------------------------
// 3. Busca os dados da aba selecionada
// -----------------------------------------------------
if ($aba === "vagas") {
