...
public class VagaDados {
    ...
    public final String fotoEmpresa; // NOVO CAMPO - guarda a URL da foto/logo da empresa
    ...
    public VagaDados(String id, String sigla, String empresa, String titulo, String cidade,
                     ...
                     String fotoEmpresa) { // ALTERADO - novo parâmetro adicionado no final
        this.id = id;
        this.sigla = sigla;
        ...
        this.fotoEmpresa = fotoEmpresa; // NOVO - atribuição do novo campo
    }
